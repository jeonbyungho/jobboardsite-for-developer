...
public class SignInService {
	...
	public ResultMessage<BusinessMemberDTO> signIn(String username, String password){
		PasswordEncryptionUtil pwEncrypt = PasswordEncryptionUtil.getInstance();
		Optional<BusinessMemberDTO> opt = bizMemberDao.signIn(username, pwEncrypt.encrypt(password));
		...
		return new ResultMessage<BusinessMemberDTO>(opt.orElse(null), msg);
	}
}
